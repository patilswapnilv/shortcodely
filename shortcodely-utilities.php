...
/*-----------------------------------*/
function shortcodely_get_sidebar_name ($id) { /* dont need anymore ? or at least temporarily */
...
/*-----------------------------------*/
function shortcodely_save_shortcodes_sidebar() {  // when switching a theme, save the widgets we use for the shortcodes as they are getting overwritten
...
/*-----------------------------------*/
function shortcodely_restore_shortcodes_sidebar() {  // when switching a theme, restore the widgets we use for the shortcodes as they are getting overwritten
global $_wp_sidebars_widgets;
...
/*-----------------------------------*/
function shortcodely_upgrade_sidebar() { // added in 2014 February for compatibility.. keep for how long. till no sites running older versions.?
	$sidebars_widgets = wp_get_sidebars_widgets(); 
