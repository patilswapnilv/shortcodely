...
class Tests_Import_Parser extends WP_Import_UnitTestCase
{
    function setUp() 
    {
        ...
        include_once DIR_TESTDATA . '/plugins/wordpress-importer/wordpress-importer.php';
    }
    ...
    function test_escaped_cdata_closing_sequence() 
    {
        ...
        foreach( array( 'WXR_Parser_SimpleXML', 'WXR_Parser_XML', 'WXR_Parser_Regex' ) as $p ) {
            ...
            foreach ( $post['postmeta'] as $meta ) {
                switch ( $meta['key'] ) {
                case 'Plain string': $value = 'Foo'; 
                    break;
                case 'Closing CDATA': $value = ']]>'; 
                    break;
                case 'Alot of CDATA': $value = 'This has <![CDATA[ opening and ]]> closing <![CDATA[ tags like this: ]]>'; 
                    break;
