...
class Tests_POMO_PO extends WP_UnitTestCase
{
    function setUp() 
    {
        include_once ABSPATH . '/wp-includes/pomo/po.php';
...
msgstr[2] "бабаяга"', $po->export_entry($entry)
    ...
    function test_import_from_file() 
    {
        ...
        $all_types_entry = new Translation_Entry(
            array('singular' => 'strut', 'plural' => 'struts', 'context' => 'brum',
        ...
        $multiple_line_all_types_entry = new Translation_Entry(
            array('context' => 'context', 'singular' => 'singular',
        ...
        $comments_entry = new Translation_Entry(
            array('singular' => 'a', 'translator_comments' => "baba\nbrubru",
