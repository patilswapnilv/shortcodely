...
test(
    'Event: beforeExecCommand', function() {
        var cmd, ui, value;
...
test(
    'WebKit Serialization range bug', function() {
        expect(1);
...
test(
    'editor_methods - getParam', function() {
        expect(5);
...
test(
    'setContent with comment bug #4409', function() {
...
test(
    'Store/restore tabindex', function() {
...
test(
    'show/hide/isHidden and events', function() {
        var lastEvent;
...
test(
    'show/hide/isHidden and events (inline)', function() {
        var lastEvent;
...
test(
    'hide save content and hidden state while saving', function() {
...
test(
    'Block script execution', function() {
...
test(
    'kamer word bounderies', function() {
