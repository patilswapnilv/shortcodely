...
test(
    'Wrap single root text node in P', function() {
...
test(
    'Wrap single root text node in P with attrs', function() {
...
test(
    'Wrap single root text node in P but not table sibling', function() {
...
test(
    'Wrap root em in P but not table sibling', function() {
...
test(
    'Wrap single root text node in DIV', function() {
...
test(
    'Remove empty root text nodes', function() {
