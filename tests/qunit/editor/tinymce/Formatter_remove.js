...
test(
    'Inline element on selected text', function() {
...
test(
    'Inline element on selected text with remove=all', function() {
...
test(
    'Inline element on selected text with remove=none', function() {
...
test(
    'Inline element style where element is format root', function() {
...
test(
    'Partially selected inline element text', function() {
        editor.formatter.register('format', {inline : 'b'});
        editor.getBody().innerHTML = '<p><b>1234</b></p>';
        var rng = editor.dom.createRng();
...
test(
    'Partially selected inline element text with children', function() {
        editor.formatter.register('format', {inline : 'b'});
...
test(
    'Partially selected inline element text with complex children', function() {
        editor.formatter.register('format', {inline : 'span', styles : {fontWeight : 'bold'}});
...
test(
    'Inline elements with exact flag', function() {
...
test(
    'Inline elements with variables', function() {
...
test(
    'Inline elements with functions and variables', function() {
...
test(
    'End within start element', function() {
        editor.formatter.register('format', {inline : 'b'});
...
test(
    'Start and end within similar format 1', function() {
        editor.formatter.register('format', {inline : 'b'});
...
test(
    'Start and end within similar format 2', function() {
        editor.formatter.register('format', {inline : 'b'});
...
test(
    'Start and end within similar format 3', function() {
        editor.formatter.register('format', {inline : 'b'});
...
test(
    'Remove wrapper block format', function() {
...
test(
    'Remove span format within block with style', function() {
...
test(
    'Remove and verify start element', function() {
        editor.formatter.register('format', {inline : 'b'});
        var rng = editor.dom.createRng();
...
test(
    'Remove with selection collapsed ensure correct caret position', function() {
...
test(
    'Caret format at middle of text', function() {
...
test(
    'Caret format at end of text', function() {
        editor.setContent('<p><b>abc</b></p>');
        editor.formatter.register('format', {inline: 'b'});
...
test(
    'Caret format at end of text inside other format', function() {
...
test(
    'Caret format at end of text inside other format with text after 1', function() {
...
test(
    'Caret format at end of text inside other format with text after 2', function() {
        editor.setContent('<p><em><b>abc</b></em>e</p>');
...
test(
    'Toggle styles at the end of the content don\' removes the format where it is not needed.', function() {
...
test(
    'Caret format on second word in table cell', function() {
...
test(
    'remove format block on contentEditable: false block', function() {
        editor.formatter.register('format', {block: 'h1'});
...
test(
    'remove format on del using removeformat format', function() {
...
test(
    'remove format on span with class using removeformat format', function() {
...
test(
    'remove format on span with internal class using removeformat format', function() {
