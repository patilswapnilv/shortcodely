ModuleLoader.require(
    ...
    "tinymce/InsertContent"
        ...
        test(
            'insertAtCaret - i inside text, converts to em', function() {
        ...
        test(
            'insertAtCaret - ul at beginning of li', function() {
        ...
        test(
            'insertAtCaret - ul with multiple items at beginning of li', function() {
                editor.setContent('<ul><li>12</li></ul>');
                editor.focus();
                Utils.setSelection('li', 0);
        ...
        test(
            'insertAtCaret - ul at end of li', function() {
                editor.setContent('<ul><li>12</li></ul>');
                editor.focus();
        ...
        test(
            'insertAtCaret - ul with multiple items at end of li', function() {
                editor.setContent('<ul><li>12</li></ul>');
                editor.focus();
                Utils.setSelection('li', 2);
        ...
        test(
            'insertAtCaret - ul with multiple items in middle of li', function() {
                editor.setContent('<ul><li>12</li></ul>');
                editor.focus();
        ...
        test(
            'insertAtCaret - ul in middle of li with formatting', function() {
        ...
        test(
            'insertAtCaret - ul at beginning of li with empty end li', function() {
                editor.setContent('<ul><li>12</li></ul>');
                editor.focus();
                Utils.setSelection('li', 0);
        ...
        test(
            'insertAtCaret - merge inline elements', function() {
