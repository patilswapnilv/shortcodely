...
test(
    'Enter before text after EM', function() {
...
test(
    'Enter before first IMG in P', function() {
...
test(
    'Enter before first wrapped IMG in P', function() {
...
test(
    'Enter before last IMG in P with text', function() {
...
test(
    'Enter before last IMG in P with IMG sibling', function() {
...
test(
    'Enter after last IMG in P', function() {
        editor.setContent('<p>abc<img src="about:blank" /></p>');
...
test(
    'Enter before last INPUT in P with text', function() {
...
test(
    'Enter before last INPUT in P with IMG sibling', function() {
...
test(
    'Enter after last INPUT in P', function() {
        editor.setContent('<p>abc<input type="text" /></p>');
        editor.selection.setCursorLocation(editor.getBody().firstChild, 2);
        Utils.pressEnter();
...
test(
    'Enter at end of EM inside P', function() {
...
test(
    'Enter at middle of EM inside P', function() {
...
test(
    'Enter at beginning EM inside P', function() {
        editor.setContent('<p><em>abc</em></p>');
...
test(
    'Enter at end of STRONG in EM inside P', function() {
...
test(
    'Enter at middle of STRONG in EM inside P', function() {
...
test(
    'Enter at beginning STRONG in EM inside P', function() {
        editor.setContent('<p><em><strong>abc</strong></em></p>');
...
test(
    'Enter at beginning of P', function() {
        editor.setContent('<p>abc</p>');
...
test(
    'Enter at middle of P with style, id and class attributes', function() {
...
test(
    'Enter at a range between H1 and P', function() {
...
test(
    'Enter at end of H1 in HGROUP', function() {
...
test(
    'Enter inside empty TD', function() {
...
test(
    'Shift+Enter inside STRONG inside TD with BR', function() {
...
test(
    'Enter inside middle of text node in body', function() {
...
test(
    'Enter inside at beginning of text node in body', function() {
        editor.getBody().innerHTML = 'abcd';
...
test(
    'Enter inside at end of text node in body', function() {
        editor.getBody().innerHTML = 'abcd';
...
test(
    'Enter inside empty body', function() {
...
test(
    'Enter inside empty li in beginning of ol', function() {
...
test(
    'Enter inside empty li at the end of ol', function() {
...
test(
    'Shift+Enter inside empty li in the middle of ol', function() {
...
test(
    'Shift+Enter inside empty li in beginning of ol', function() {
        editor.getBody().innerHTML = (tinymce.isIE && tinymce.Env.ie < 11) ? '<ol><li></li><li>a</li></ol>' : '<ol><li><br></li><li>a</li></ol>';
        Utils.setSelection('li', 0);
        Utils.pressEnter({shiftKey: true});
        equal(editor.getContent(), '<p>\u00a0</p><ol><li>a</li></ol>');
...
test(
    'Shift+Enter inside empty li at the end of ol', function() {
        editor.getBody().innerHTML = (tinymce.isIE && tinymce.Env.ie < 11) ? '<ol><li>a</li><li></li></ol>' : '<ol><li>a</li><li><br></li></ol>';
        Utils.setSelection('li:last', 0);
        Utils.pressEnter({shiftKey: true});
        equal(editor.getContent(), '<ol><li>a</li></ol><p>\u00a0</p>');
...
test(
    'Enter inside empty li in the middle of ol with forced_root_block: false', function() {
...
test(
    'Enter inside empty li in beginning of ol with forced_root_block: false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = (tinymce.isIE && tinymce.Env.ie < 11) ? '<ol><li></li><li>a</li></ol>' : '<ol><li><br></li><li>a</li></ol>';
        Utils.setSelection('li', 0);
        Utils.pressEnter();
...
test(
    'Enter inside empty li at the end of ol with forced_root_block: false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = (tinymce.isIE && tinymce.Env.ie < 11) ? '<ol><li>a</li><li></li></ol>' : '<ol><li>a</li><li><br></li></ol>';
        Utils.setSelection('li:last', 0);
        Utils.pressEnter();
...
test(
    'Enter inside empty li in the middle of ol', function() {
        editor.getBody().innerHTML = (tinymce.isIE && tinymce.Env.ie < 11) ? '<ol><li>a</li><li></li><li>b</li></ol>' : '<ol><li>a</li><li><br></li><li>b</li></ol>';
        Utils.setSelection('li:nth-child(2)', 0);
        Utils.pressEnter();
        equal(editor.getContent(), '<ol><li>a</li></ol><p>\u00a0</p><ol><li>b</li></ol>');
...
test(
    'Enter inside empty LI in beginning of OL in LI', function() {
...
test(
    'Enter inside empty LI in middle of OL in LI', function() {
        editor.getBody().innerHTML = Utils.trimBrsOnIE(
            '<ol>' +
            '<li>a' +
                '<ol>' +
...
test(
    'Enter inside empty LI in end of OL in LI', function() {
        editor.getBody().innerHTML = Utils.trimBrsOnIE(
            '<ol>' +
            '<li>a' +
                '<ol>' +
...
if (!tinymce.Env.ie || tinymce.Env.ie > 8) {
    test(
        'Enter before nested list', function() {
            editor.getBody().innerHTML = Utils.trimBrsOnIE(
                '<ol>' +
                '<li>a' +
                '<ul>' +
...
test(
    'Enter inside empty LI in beginning of OL in OL', function() {
        editor.getBody().innerHTML = Utils.trimBrsOnIE(
            '<ol>' +
            '<li>a</li>' +
            '<ol>' +
...
test(
    'Enter inside empty LI in middle of OL in OL', function() {
        editor.getBody().innerHTML = Utils.trimBrsOnIE(
            '<ol>' +
            '<li>a</li>' +
            '<ol>' +
...
test(
    'Enter inside empty LI in end of OL in OL', function() {
        editor.getBody().innerHTML = Utils.trimBrsOnIE(
            '<ol>' +
            '<li>a</li>' +
            '<ol>' +
...
test(
    'Enter at beginning of first DT inside DL', function() {
...
test(
    'Enter at beginning of first DD inside DL', function() {
...
test(
    'Enter at beginning of middle DT inside DL', function() {
...
test(
    'Enter at beginning of middle DD inside DL', function() {
...
test(
    'Enter at end of last DT inside DL', function() {
        editor.getBody().innerHTML = '<dl><dt>a</dt></dl>';
...
test(
    'Enter at end of last DD inside DL', function() {
        editor.getBody().innerHTML = '<dl><dd>a</dd></dl>';
...
test(
    'Enter at end of last empty DT inside DL', function() {
...
test(
    'Enter at end of last empty DD inside DL', function() {
...
test(
    'Enter at beginning of P inside LI', function() {
...
test(
    'Enter inside middle of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 2);
        Utils.pressEnter();
...
test(
    'Enter at end of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
...
test(
    'Shift+Enter at beginning of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 0);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter inside middle of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 2);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter at end of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 4);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Ctrl+Enter at beginning of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 0);
...
test(
    'Ctrl+Enter inside middle of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 2);
        Utils.pressEnter({ctrlKey: true});
...
test(
    'Ctrl+Enter at end of P inside LI', function() {
        editor.getBody().innerHTML = '<ol><li><p>abcd</p></li></ol>';
        Utils.setSelection('p', 4);
        Utils.pressEnter({ctrlKey: true});
...
test(
    'Enter in the middle of text in P with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
...
test(
    'Enter at the end of text in P with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = '<p>abc</p>';
        Utils.setSelection('p', 3);
        Utils.pressEnter();
...
test(
    'Enter at the middle of text in BODY with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = 'abcd';
        Utils.setSelection('body', 2);
        editor.focus();
...
test(
    'Enter at the beginning of text in BODY with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = 'abcd';
        Utils.setSelection('body', 0);
        editor.focus();
...
test(
    'Enter at the end of text in BODY with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = 'abcd';
        Utils.setSelection('body', 4);
        editor.focus();
...
test(
    'Enter in empty P at the end of a blockquote and end_container_on_empty_block: true', function() {
...
test(
    'Enter in empty P at the beginning of a blockquote and end_container_on_empty_block: true', function() {
        editor.settings.end_container_on_empty_block = true;
...
test(
    'Enter in empty P at in the middle of a blockquote and end_container_on_empty_block: true', function() {
        editor.settings.end_container_on_empty_block = true;
...
test(
    'Enter inside empty P with empty P siblings', function() {
...
test(
    'Enter at end of H1 with forced_root_block_attrs', function() {
...
test(
    'Shift+Enter at beginning of P', function() {
        editor.getBody().innerHTML = '<p>abc</p>';
        Utils.setSelection('p', 0);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter in the middle of P', function() {
...
test(
    'Shift+Enter at the end of P', function() {
        editor.getBody().innerHTML = '<p>abcd</p>';
        Utils.setSelection('p', 4);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter in the middle of B with a BR after it', function() {
...
test(
    'Shift+Enter at the end of B with a BR after it', function() {
        editor.getBody().innerHTML = '<p><b>abcd</b><br></p>';
...
test(
    'Enter in beginning of PRE', function() {
...
test(
    'Enter in the middle of PRE', function() {
...
test(
    'Enter at the end of PRE', function() {
        editor.getBody().innerHTML = '<pre>abcd</pre>';
...
test(
    'Enter in beginning of PRE and br_in_pre: false', function() {
...
test(
    'Enter in the middle of PRE and br_in_pre: false', function() {
        editor.settings.br_in_pre = false;
        editor.getBody().innerHTML = '<pre>abcd</pre>';
        Utils.setSelection('pre', 2);
        Utils.pressEnter();
...
test(
    'Enter at the end of PRE and br_in_pre: false', function() {
        editor.settings.br_in_pre = false;
        editor.getBody().innerHTML = '<pre>abcd</pre>';
        Utils.setSelection('pre', 4);
        Utils.pressEnter();
...
test(
    'Shift+Enter in beginning of PRE', function() {
        editor.getBody().innerHTML = '<pre>abc</pre>';
        Utils.setSelection('pre', 0);
        Utils.pressEnter({shiftKey: true});
        equal(editor.getContent(), '<pre>\u00a0</pre><pre>abc</pre>');
...
test(
    'Shift+Enter in the middle of PRE', function() {
        editor.getBody().innerHTML = '<pre>abcd</pre>';
        Utils.setSelection('pre', 2);
        Utils.pressEnter({shiftKey: true});
        equal(editor.getContent(), '<pre>ab</pre><pre>cd</pre>');
...
test(
    'Shift+Enter at the end of PRE', function() {
        editor.getBody().innerHTML = '<pre>abcd</pre>';
        Utils.setSelection('pre', 4);
        Utils.pressEnter({shiftKey: true});
        equal(editor.getContent(), '<pre>abcd</pre><p>\u00a0</p>');
...
test(
    'Shift+Enter in beginning of P with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = '<p>abc</p>';
        Utils.setSelection('p', 0);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter in middle of P with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = '<p>abcd</p>';
        Utils.setSelection('p', 2);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter at the end of P with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = '<p>abc</p>';
        Utils.setSelection('p', 3);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Shift+Enter in body with forced_root_block set to false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = 'abcd';
...
test(
    'Enter at the end of DIV layer', function() {
        editor.settings.br_in_pre = false;
...
test(
    'Enter in div inside contentEditable:false div', function() {
...
test(
    'Enter in div with contentEditable:true inside contentEditable:false div', function() {
...
test(
    'Enter in span with contentEditable:true inside contentEditable:false div', function() {
...
test(
    'Shift+Enter in span with contentEditable:true inside contentEditable:false div', function() {
        editor.getBody().innerHTML = '<div data-mce-contenteditable="false"><span data-mce-contenteditable="true">abcd</span></div>';
        Utils.setSelection('span', 2);
        Utils.pressEnter({shiftKey: true});
...
test(
    'Enter in span with contentEditable:true inside contentEditable:false div and forced_root_block: false', function() {
        editor.settings.forced_root_block = false;
        editor.getBody().innerHTML = '<div data-mce-contenteditable="false"><span data-mce-contenteditable="true">abcd</span></div>';
        Utils.setSelection('span', 2);
        Utils.pressEnter();
...
test(
    'Enter in em within contentEditable:true div inside contentEditable:false div', function() {
...
test(
    'Enter at end of text in a span inside a P and keep_styles: false', function() {
...
test(
    'Shift+enter in LI when forced_root_block: false', function() {
        editor.settings.forced_root_block = false;
...
test(
    'Enter when forced_root_block: false and force_p_newlines: true', function() {
        editor.settings.forced_root_block = false;
...
test(
    'Enter at end of br line', function() {
        editor.settings.forced_root_block = false;
        editor.settings.force_p_newlines = true;
...
if (!tinymce.Env.ie || tinymce.Env.ie > 8) {
    test(
        'Enter before BR between DIVs', function() {
...
if (window.getSelection) {
    test(
        'Enter behind table element', function() {
            var rng = editor.dom.createRng();
    ...
    test(
        'Enter before table element', function() {
            var rng = editor.dom.createRng();
    ...
    test(
        'Enter behind table followed by a p', function() {
            var rng = editor.dom.createRng();
    ...
    test(
        'Enter before table element preceded by a p', function() {
            var rng = editor.dom.createRng();
    ...
    test(
        'Enter twice before table element', function(){
            var rng = editor.dom.createRng();
    ...
    test(
        'Enter after span with space', function() {
