ModuleLoader.require(
    ...
    "tinymce/text/Zwsp"
        ...
        test(
            'left/right over cE=false inline', function() {
        ...
        test(
            'left/right over cE=false block', function() {
        ...
        test(
            'left before cE=false block and type', function() {
                editor.setContent('<p contenteditable="false">1</p>');
                editor.selection.select(editor.$('p')[0]);
        ...
        test(
            'right after cE=false block and type', function() {
                editor.setContent('<p contenteditable="false">1</p>');
                editor.selection.select(editor.$('p')[0]);
        ...
        test(
            'up from P to inline cE=false', function() {
        ...
        test(
            'down from P to inline cE=false', function() {
        ...
        test(
            'backspace on selected cE=false block', function() {
                editor.setContent('<p contenteditable="false">1</p>');
                editor.selection.select(editor.$('p')[0]);
        ...
        test(
            'backspace after cE=false block', function() {
                editor.setContent('<p contenteditable="false">1</p>');
                editor.selection.select(editor.$('p')[0]);
        ...
        test(
            'delete on selected cE=false block', function() {
                editor.setContent('<p contenteditable="false">1</p>');
                editor.selection.select(editor.$('p')[0]);
        ...
        test(
            'delete inside nested cE=true block element', function() {
        ...
        test(
            'backspace from block to after cE=false inline', function() {
        ...
        test(
            'delete from block to before cE=false inline', function() {
        ...
        test(
            'backspace from before cE=false block to text', function() {
        ...
        test(
            'backspace from before first cE=false block', function() {
        ...
        test(
            'backspace from before cE=false block to after cE=false block', function() {
        ...
        test(
            'delete from after cE=false block to text', function() {
                editor.setContent('<p>1</p><p contenteditable="false">2</p><p>3</p>');
                editor.selection.select(editor.dom.select('p')[1]);
        ...
        test(
            'delete from after last cE=false block', function() {
        ...
        test(
            'delete from after cE=false block to before cE=false block', function() {
                editor.setContent('<p contenteditable="false">1</p><p contenteditable="false">2</p>');
                editor.selection.select(editor.dom.select('p')[0]);
                rightArrow();
                assertCaretInCaretBlockContainer();
        ...
        test(
            'backspace from empty block to after cE=false', function() {
        ...
        test(
            'delete from empty block to before cE=false', function() {
        ...
        test(
            'click on link in cE=false', function() {
        ...
        test(
            'click next to cE=false block', function() {
                editor.setContent(
