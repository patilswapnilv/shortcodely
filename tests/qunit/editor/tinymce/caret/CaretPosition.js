ModuleLoader.require(
    ...
    "tinymce/caret/CaretPosition"
        ...
        test(
            'getClientRects between inline node and cE=false', function() {
                setupHtml(
        ...
        test(
            'getClientRects at last visible character', function() {
                setupHtml('<b>a  </b>');
        ...
        test(
            'getClientRects at extending character', function() {
                setupHtml('a\u0301b');
        ...
        test(
            'getClientRects at whitespace character', function() {
                setupHtml('  a  ');
