ModuleLoader.require(
    ...
    "tinymce/text/Zwsp"
        ...
        test(
            'isInSameBlock', function() {
                setupHtml('<p>abc</p><p>def<b>ghj</b></p>');

                strictEqual(
                    CaretUtils.isInSameBlock(
        ...
        test(
            'isInSameEditingHost', function() {
                ...
                strictEqual(
                    CaretUtils.isInSameEditingHost(
                        CaretPosition(findElm('p:first').firstChild, 0),
        ...
        test(
            'isBeforeContentEditableFalse', function() {
                setupHtml(
        ...
        test(
            'isAfterContentEditableFalse', function() {
                setupHtml(
                    '<span contentEditable="false"></span>' +
                    '<span contentEditable="false"></span>a'
                );
        ...
        test(
            'normalizeRange break at candidate', function() {
                setupHtml(
        ...
        test(
            'normalizeRange at block caret container', function() {
                setupHtml(
        ...
        test(
            'normalizeRange at inline caret container', function() {
                setupHtml(
                    'abc<span contentEditable="false">1</span>def'
                );
        ...
        test(
            'normalizeRange at inline caret container (combined)', function() {
                setupHtml(
        ...
        test(
            'normalizeRange at inline caret container after block', function() {
                setupHtml(
