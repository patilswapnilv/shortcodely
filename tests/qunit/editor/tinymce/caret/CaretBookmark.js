ModuleLoader.require(
    ...
    'tinymce/caret/CaretPosition'
        ...
        test(
            'create text index on fragmented text nodes', function() {
                setupHtml('a');
        ...
        test(
            'create br element index', function() {
        ...
        test(
            'create deep element index', function() {
        ...
        test(
            'create deep text index', function() {
        ...
        test(
            'create element index from bogus', function() {
        ...
        test(
            'resolve element index', function() {
                setupHtml('<b></b><i></i><b></b>');
        ...
        test(
            'resolve odd element names', function() {
        ...
        test(
            'resolve deep element index', function() {
                setupHtml('<p><span>a</span><span><b id="a"></b><b id="b"></b><b id="c"></b></span></p>');
        ...
        test(
            'resolve text index on fragmented text nodes', function() {
                setupHtml('a');
                getRoot().appendChild(document.createTextNode('b'));
                getRoot().appendChild(document.createTextNode('c'));
                getRoot().appendChild(document.createElement('b'));
        ...
        test(
            'resolve text index with to high offset', function() {
                setupHtml('abc');
        ...
        test(
            'resolve invalid paths', function() {
                setupHtml('<b><i></i></b>');
