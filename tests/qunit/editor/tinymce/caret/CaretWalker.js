ModuleLoader.require(
    ...
    "tinymce/caret/CaretPosition"
        ...
        test(
            'within text node in root', function() {
                setupHtml('abc');
        ...
        test(
            'within text node in element', function() {
                setupHtml('<p>abc</p>');
        ...
        test(
            'from index text node over comment', function() {
        ...
        test(
            'from text to text across elements', function() {
        ...
        test(
            'from text to text across elements with siblings', function() {
        ...
        test(
            'from input to input across elements', function() {
        ...
        test(
            'next br to br across elements', function() {
        ...
        test(
            'prev br to br across elements', function() {
                setupHtml('<p><br></p><p><br></p>');
        ...
        test(
            'from before/after br to text', function() {
        ...
        test(
            'over script/style/textarea', function() {
        ...
        */
        test(
            'from inside cE=true in cE=false to after cE=false', function() {
                setupHtml(
                    '<p>' +
        ...
        test(
            'around cE=false inside nested cE=true', function() {
                setupHtml(
                    '<span contentEditable="false">' +
                    '<span contentEditable="true">' +
        ...
        test(
            'left/right between cE=false inlines in different blocks', function() {
                setupHtml(
                    '<p>' +
        ...
        test(
            'never into caret containers', function() {
