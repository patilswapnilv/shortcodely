ModuleLoader.require(
    ...
    "tinymce/text/Zwsp"
        ...
        test(
            'isCaretContainerBlock', function() {
        ...
        test(
            'isCaretContainerInline', function() {
        ...
        test(
            'insertInline before element', function() {
        ...
        test(
            'insertInline after element', function() {
                setViewHtml('<span contentEditable="false">1</span>');
        ...
        test(
            'insertInline between elements', function() {
        ...
        test(
            'insertInline before element with ZWSP', function() {
        ...
        test(
            'insertInline after element with ZWSP', function() {
        ...
        test(
            'insertBlock before element', function() {
                setViewHtml('<span contentEditable="false">1</span>');
        ...
        test(
            'insertBlock after element', function() {
                setViewHtml('<span contentEditable="false">1</span>');
        ...
        test(
            'insertBlock between elements', function() {
                setViewHtml('<span contentEditable="false">1</span><span contentEditable="false">1</span>');
                equal(CaretContainer.insertInline(getRoot().lastChild, true), getRoot().childNodes[1]);
                equal(CaretContainer.isCaretContainerInline(getRoot().childNodes[1]), true);
            }
        ...
        test(
            'startsWithCaretContainer', function() {
        ...
        test(
            'endsWithCaretContainer', function() {
