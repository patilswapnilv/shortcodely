ModuleLoader.require(
    ...
    "tinymce/text/Zwsp"
        ...
        test(
            'isCaretCandidate', function() {
                $.each(
                    "img input textarea hr table iframe video audio object".split(' '), function(index, name) {
        ...
        test(
            'isAtomic', function() {
                $.each(
                    ["img", "input", "textarea", "hr"], function(index, name) {
        ...
        test(
            'isEditableCaretCandidate', function() {
