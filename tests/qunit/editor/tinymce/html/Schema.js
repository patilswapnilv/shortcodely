...
test(
    'Valid elements global rule', function() {
        expect(1);
...
test(
    'Whildcard element rule', function() {
        var schema;
...
test(
    'Whildcard attribute rule', function() {
        var schema;
...
test(
    'Valid attributes and attribute order', function() {
        var schema;
...
test(
    'Required any attributes', function() {
        var schema;
...
test(
    'Default attribute values', function() {
        var schema;
...
test(
    'Forced attribute values', function() {
        var schema;
...
test(
    'Required attribute values', function() {
        var schema;
...
test(
    'addCustomElements/getCustomElements', function() {
        var schema;
