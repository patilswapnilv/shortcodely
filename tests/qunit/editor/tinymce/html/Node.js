...
test(
    'append inside empty node', function() {
        var root, node;
...
test(
    'append node after node', function() {
        var root, node, node2;
...
test(
    'append existing node before other existing node', function() {
        var root, node, node2;
...
test(
    'remove unattached node', function() {
        expect(1);
...
test(
    'insert after and between two nodes', function() {
