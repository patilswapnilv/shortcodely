(function() {
    ...
    test(
        'Parse script elements', function() {
            var counter, parser;
    ...
    test(
        'Preserve internal elements', function() {
    ...
    test(
        'Remove internal elements', function() {
            var counter, parser, schema;
    ...
    test(
        'Parse attr with backslash #5436', function() {
            var counter, parser;
    ...
    test(
        'Parse no attributes span before strong', function() {
            var counter, parser;
    ...
    test(
        'Conditional comments (allowed)', function() {
            var counter, parser;
    ...
    test(
        'Conditional comments (denied)', function() {
            var counter, parser;
    ...
    test(
        'Parse script urls (allowed)', function() {
            var counter, parser;
    ...
    test(
        'Parse script urls (allowed html data uris)', function() {
            var counter, parser;
    ...
    test(
        'Parse script urls (denied)', function() {
            var counter, parser;
    ...
    test(
        'Parse away bogus elements', function() {
