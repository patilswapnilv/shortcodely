...
test(
    'HTML elements non-conforming to HTML 5.0', function() {
        var testString;
...
test(
    'Obsolete (but still conforming) HTML attributes', function() {
        var testString;
...
test(
    'Obsolete attributes in HTML 5.0', function() {
        var testString, text;
