...
test(
    'Basic parsing/serializing', function() {
...
test(
    'Colors force hex and lowercase', function() {
        var styles = new tinymce.html.Styles();
...
test(
    'Urls convert urls and force format', function() {
        var styles = new tinymce.html.Styles(
