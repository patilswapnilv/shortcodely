(function() {
    ...
    test(
        'Whitespace before/after invalid element with text in block', function() {
    ...
    test(
        'Whitespace before/after invalid element whitespace element in block', function() {
    ...
    test(
        'Whitespace preserved in PRE', function() {
            parser = new tinymce.html.DomParser({}, schema);
            root = parser.parse('  \t\r\n  <PRE>  \t\r\n   test  \t\r\n   </PRE>   \t\r\n  ');
    ...
    test(
        'Whitespace preserved in SPAN inside PRE', function() {
            parser = new tinymce.html.DomParser({}, schema);
            root = parser.parse('  \t\r\n  <PRE>  \t\r\n  <span>    test    </span> \t\r\n   </PRE>   \t\r\n  ');
            equal(serializer.serialize(root), '<pre>  \t\r\n  <span>    test    </span> \t\r\n   </pre>', 'Whitespace around and inside PRE');
    ...
    test(
        'Parse invalid contents', function() {
            var parser, root;
    ...
    test(
        'addNodeFilter', function() {
            ...
            parser.addNodeFilter(
                '#comment', function(nodes, name, args) {
    ...
    test(
        'addNodeFilter multiple names', function() {
            var parser, results = {};
            ...
            parser = new tinymce.html.DomParser({}, schema);
            parser.addNodeFilter(
                '#comment,#text', function(nodes, name, args) {
    ...
    test(
        'addNodeFilter with parser args', function() {
            var parser, result;
    ...
    test(
        'addAttributeFilter multiple', function() {
            var parser, results = {};
            ...
            parser = new tinymce.html.DomParser({});
            parser.addAttributeFilter(
                'src,href', function(nodes, name, args) {
                    results[name] = {nodes : nodes, name : name, args : args};
                }
            );
    ...
    test(
        'Fix orphan LI elements', function() {
            var parser;
    ...
    test(
        'Remove empty elements', function() {
    ...
    test(
        'Self closing list elements', function() {
    ...
    test(
        'Remove redundant br elements', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Replace br with nbsp when wrapped in two inline elements and one block', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Replace br with nbsp when wrapped in an inline element and placed in the root', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Don\'t replace br inside root element when there is multiple brs', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Don\'t replace br inside root element when there is siblings', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Remove br in invalid parent bug', function() {
    ...
    test(
        'Forced root blocks attrs', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Parse contents with html4 anchors and allow_html_in_named_anchor: false', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Parse contents with html5 anchors and allow_html_in_named_anchor: false', function() {
    ...
    test(
        'Parse contents with html4 anchors and allow_html_in_named_anchor: true', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Parse contents with html5 anchors and allow_html_in_named_anchor: true', function() {
            var parser, root, schema = new tinymce.html.Schema({schema: "html5"});
    ...
    test(
        'Parse contents with html5 self closing datalist options', function() {
            var parser, root, schema = new tinymce.html.Schema({schema: "html5"});
    ...
    test(
        'Parse inline contents before block bug #5424', function() {
            var parser, root, schema = new tinymce.html.Schema({schema: "html5"});
    ...
    test(
        'Invalid text blocks within a li', function() {
    ...
    test(
        'Invalid inline element with space before', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Valid classes multiple elements', function() {
    ...
    test(
        'Remove empty list blocks', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Preserve space in inline span', function() {
            var parser, root, schema = new tinymce.html.Schema();
    ...
    test(
        'Bug #7543 removes whitespace between bogus elements before a block', function() {
            var serializer = new tinymce.html.Serializer();

            equal(
                serializer.serialize(
                    new tinymce.html.DomParser().parse(
    ...
    test(
        'Bug #7582 removes whitespace between bogus elements before a block', function() {
            var serializer = new tinymce.html.Serializer();
