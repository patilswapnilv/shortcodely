...
asyncTest(
    'Externally destroyed editor', function() {
        tinymce.remove();
...
asyncTest(
    'Init/remove on same id', function() {
...
asyncTest(
    'Init editor async with proper editors state', function() {
...
test(
    'overrideDefaults', function() {
        ...
        deepEqual(
            new tinymce.Editor('ed3', {}, tinymce).settings.external_plugins, {
                "plugina": "//domain/plugina.js",
                "pluginb": "//domain/pluginb.js"
            }
        );
...
test(
    'Init inline editor on invalid targets', function() {
        var invalidNames;
        ...
        tinymce.each(
            invalidNames.split(' '), function (invalidName) {
