(function() {
    ...
    test(
        "pack: default, align: default, flex: default", function() {
            panel = renderPanel({});
    ...
    test(
        "pack: default, align: default, flex: default, borders", function() {
    ...
    test(
        "pack: default, flex: 1, minWidth: various", function() {
            panel = renderPanel(
                {
                    defaults: {flex: 1},
                    items: [
    ...
    test(
        "pack: start, flex: default", function() {
            panel = renderPanel(
                {
                    pack: "start"
                }
    ...
    test(
        "pack: end, flex: default", function() {
            panel = renderPanel(
                {
                    pack: "end"
                }
    ...
    test(
        "pack: center, flex: default", function() {
            panel = renderPanel(
                {
                    pack: "center"
                }
    ...
    test(
        "pack: center, spacing: 3", function() {
            panel = renderPanel(
                {
                    pack: "center",
                    spacing: 3
    ...
    test(
        "pack: start, spacing: 3, padding: 3", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    padding: 3,
    ...
    test(
        "pack: start, align: start", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    align: "start"
    ...
    test(
        "pack start, align: center", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    align: "center"
    ...
    test(
        "pack: start, align: stretch", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    align: "stretch"
    ...
    test(
        "pack: start, padding: 3, align: stretch", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    align: "stretch",
    ...
    test(
        "pack: start, flex: mixed values", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    items: [
    ...
    test(
        "pack: justify, padding: 3", function() {
            panel = renderPanel(
                {
                    pack: "justify",
                    padding: 3
    ...
    test(
        "pack: justify, minWidth: mixed values, padding: 3", function() {
            panel = renderPanel(
                {
                    pack: "justify",
                    padding: 3,
    ...
    test(
        "pack: start, flex: 1, maxWidth: 80 on second", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    width: 400,
    ...
    test(
        "pack: start, flex: 1, minWidth: 150 on second", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    width: 400,
    ...
    test(
        "pack: start, flex: default, hide item and reflow", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    autoResize: true,
    ...
    test(
        "pack: start, flex: 1, reflow after resize outer width", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    items: [
    ...
    test(
        "pack: start, maxWidth/maxHeight: 100, item minWidth/maxHeight: 200 (overflow W+H)", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    autoResize: true,
    ...
    test(
        "pack: start, direction: column, maxWidth/maxHeight: 100, padding: 20, spacing: 10, item minWidth/maxHeight: 200 (overflow W+H)", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    direction: "column",
    ...
    test(
        "pack: start, maxWidth/maxHeight: 100, item minWidth/maxHeight: 200 (overflow W)", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    autoResize: true,
    ...
    test(
        "pack: start, maxWidth/maxHeight: 100, item minWidth/maxHeight: 200 (overflow H)", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    autoResize: true,
    ...
    test(
        "pack: start, minWidth: 200, item minWidth: 100 (underflow)", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    autoResize: true,
    ...
    test(
        "pack: start, flex: 1, border: 1, reflow after resize inner width", function() {
            panel = renderPanel(
                {
                    pack: "start",
                    border: 1,
    ...
    test(
        "row flexbox in row flexbox", function() {
    ...
    test(
        "row flexbox in row flexbox hide inner item and reflow", function() {
            panel = tinymce.ui.Factory.create(
                {
                    type: 'panel',
                    layout: 'flex',
    ...
    test(
        "direction: column, pack: default, align: default, flex: default", function() {
    ...
    test(
        "direction: column, pack: default, flex: 1", function() {
            panel = renderColumnPanel(
                {
                    defaults: {flex: 1}
                }
    ...
    test(
        "direction: column, pack: default, flex: 1, minWidth: various", function() {
            panel = renderColumnPanel(
                {
                    defaults: {flex: 1},
                    items: [
    ...
    test(
        "direction: column, pack: start, flex: default", function() {
            panel = renderColumnPanel(
                {
                    pack: "start"
                }
    ...
    test(
        "direction: column, pack: start, flex: 1", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    defaults: {flex: 1}
    ...
    test(
        "direction: column, pack: end, flex: default", function() {
            panel = renderColumnPanel(
                {
                    pack: "end"
                }
    ...
    test(
        "direction: column, pack: end, flex: 1", function() {
            panel = renderColumnPanel(
                {
                    pack: "end",
                    defaults: {flex: 1}
    ...
    test(
        "direction: column, pack: center, flex: default", function() {
            panel = renderColumnPanel(
                {
                    pack: "center"
                }
    ...
    test(
        "direction: column, pack: center, flex: 1", function() {
            panel = renderColumnPanel(
                {
                    pack: "center",
                    defaults: {flex: 1}
    ...
    test(
        "direction: column, pack: start, spacing: 3", function() {
            panel = renderColumnPanel(
                {
                    layout: "flex",
                    pack: "start",
    ...
    test(
        "direction: column, pack: end, spacing: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "end",
                    spacing: 3
    ...
    test(
        "direction: column, pack: center, spacing: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "center",
                    spacing: 3
    ...
    test(
        "direction: column, pack: start, padding: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    padding: 3
    ...
    test(
        "direction: column, pack: start, spacing: 3, padding: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    padding: 3,
    ...
    test(
        "direction: column, pack: start, align: start", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    align: "start"
    ...
    test(
        "direction: column, pack start, align: center", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    align: "center"
    ...
    test(
        "direction: column, pack: start, align: end", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    align: "end"
    ...
    test(
        "direction: column, pack: start, align: stretch", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    align: "stretch"
    ...
    test(
        "direction: column, pack: start, padding: 3, align: stretch", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    align: "stretch",
    ...
    test(
        "direction: column, pack: start, flex: mixed values", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    items: [
    ...
    test(
        "direction: column, pack: justify", function() {
            panel = renderColumnPanel(
                {
                    pack: "justify"
                }
    ...
    test(
        "direction: column, pack: justify, padding: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "justify",
                    padding: 3
    ...
    test(
        "direction: column, pack: justify, minHeight: mixed values, padding: 3", function() {
            panel = renderColumnPanel(
                {
                    pack: "justify",
                    padding: 3,
    ...
    test(
        "direction: column, pack: start, flex: 1, maxHeight: 80 on second", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    height: 400,
    ...
    test(
        "direction: column, pack: start, flex: 1, minHeight: 150 on second", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    height: 400,
    ...
    test(
        "direction: column, pack: start, flex: 1, reflow after resize outer height", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    items: [
    ...
    test(
        "direction: column, pack: start, flex: 1, border: 1, reflow after resize inner width", function() {
            panel = renderColumnPanel(
                {
                    pack: "start",
                    border: 1,
    ...
    test(
        "direction: column, row flexbox in row flexbox and resize parent", function() {
            panel = tinymce.ui.Factory.create(
                {
                    type: 'panel',
                    layout: 'flex',
