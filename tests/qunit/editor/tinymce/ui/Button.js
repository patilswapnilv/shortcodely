(function() {
    ...
    test(
        "button text, size default", function() {
    ...
    test(
        "button text, size large", function() {
    ...
    test(
        "button text, size small", function() {
    ...
    test(
        "button text, width 100, height 100", function() {
    ...
    test(
        "button icon, size default", function() {
    ...
    test(
        "button icon, size small", function() {
    ...
    test(
        "button icon, size large", function() {
    ...
    test(
        "button icon, width 100, height 100", function() {
    ...
    test(
        "button text & icon, size default", function() {
    ...
    test(
        "button text & icon, size large", function() {
    ...
    test(
        "button text & icon, size small", function() {
    ...
    test(
        "button text & icon, width 100, height 100", function() {
