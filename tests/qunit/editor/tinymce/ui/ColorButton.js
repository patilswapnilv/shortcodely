(function() {
    ...
    test(
        "colorbutton text, size default", function() {
    ...
    test(
        "colorbutton text, size large", function() {
    ...
    test(
        "colorbutton text, size small", function() {
    ...
    test(
        "colorbutton text, width 100, height 100", function() {
    ...
    test(
        "colorbutton icon, size default", function() {
    ...
    test(
        "colorbutton icon, size small", function() {
    ...
    test(
        "colorbutton icon, size large", function() {
    ...
    test(
        "colorbutton icon, width 100, height 100", function() {
    ...
    test(
        "colorbutton text & icon, size default", function() {
    ...
    test(
        "colorbutton text & icon, size large", function() {
    ...
    test(
        "colorbutton text & icon, size small", function() {
    ...
    test(
        "colorbutton text & icon, width 100, height 100", function() {
    ...
    test(
        "colorbutton click event", function() {
