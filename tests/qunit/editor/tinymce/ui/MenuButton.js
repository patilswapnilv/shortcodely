(function() {
    ...
    test(
        "menubutton text, size default", function() {
    ...
    test(
        "menubutton text, size large", function() {
    ...
    test(
        "menubutton text, size small", function() {
    ...
    test(
        "menubutton text, width 100, height 100", function() {
    ...
    test(
        "menubutton icon, size default", function() {
    ...
    test(
        "menubutton icon, size small", function() {
    ...
    test(
        "menubutton icon, size large", function() {
    ...
    test(
        "menubutton icon, width 100, height 100", function() {
    ...
    test(
        "menubutton text & icon, size default", function() {
    ...
    test(
        "menubutton text & icon, size large", function() {
    ...
    test(
        "menubutton text & icon, size small", function() {
    ...
    test(
        "menubutton text & icon, width 100, height 100", function() {
    ...
    test(
        "menubutton click event", function() {
