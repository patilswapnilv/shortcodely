(function() {
    ...
    test(
        "automatic grid size 2x2", function() {
    ...
    */
    ...
    test(
        "spacing: 3, automatic grid size 2x2", function() {
            var panel = renderGridPanel(
                {
                    spacing: 3,
                    items: [
    ...
    test(
        "padding: 3, automatic grid size 2x2", function() {
            var panel = renderGridPanel(
                {
                    padding: 3,
                    items: [
    ...
    test(
        "spacing: 3, padding: 3, automatic grid size 2x2", function() {
            var panel = renderGridPanel(
                {
                    padding: 3,
                    spacing: 3,
    ...
    test(
        "inner elements 100x100 maxWidth/maxHeight: 118 (overflow W+H)", function() {
            var panel = renderGridPanel(
                {
                    autoResize: true,
                    autoScroll: true,
    ...
    test(
        "inner elements: 100x100, padding: 20, spacing: 10, maxWidth/maxHeight: 118 (overflow W+H)", function() {
            var panel = renderGridPanel(
                {
                    autoResize: true,
                    autoScroll: true,
    ...
    test(
        "inner elements 100x100 maxWidth: 118 (overflow W)", function() {
            var panel = renderGridPanel(
                {
                    autoResize: true,
                    autoScroll: true,
    ...
    test(
        "inner elements 100x100 maxHeight: 118 (overflow H)", function() {
            var panel = renderGridPanel(
                {
                    autoResize: true,
                    autoScroll: true,
