(function() {
    ...
    test(
        "no title, no buttonbar, autoResize", function() {
    ...
    test(
        "title, no buttonbar, autoResize, title is widest", function() {
            var win = createWindow(
                {
                    x: 100,
                    y: 120,
    ...
    test(
        "buttonbar, autoResize, buttonbar is widest", function() {
            var win = createWindow(
                {
                    x: 100,
                    y: 120,
    ...
    test(
        "buttonbar, title, autoResize, content is widest", function() {
            var win = createWindow(
                {
                    x: 100,
                    y: 120,
