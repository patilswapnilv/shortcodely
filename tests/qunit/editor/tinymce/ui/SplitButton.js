(function() {
    ...
    test(
        "splitbutton text, size default", function() {
    ...
    test(
        "splitbutton text, size large", function() {
    ...
    test(
        "splitbutton text, size small", function() {
    ...
    test(
        "splitbutton text, width 100, height 100", function() {
    ...
    test(
        "splitbutton icon, size default", function() {
    ...
    test(
        "splitbutton icon, size small", function() {
    ...
    test(
        "splitbutton icon, size large", function() {
    ...
    test(
        "splitbutton icon, width 100, height 100", function() {
    ...
    test(
        "splitbutton text & icon, size default", function() {
    ...
    test(
        "splitbutton text & icon, size large", function() {
    ...
    test(
        "splitbutton text & icon, size small", function() {
    ...
    test(
        "splitbutton text & icon, width 100, height 100", function() {
    ...
    test(
        "splitbutton click event", function() {
