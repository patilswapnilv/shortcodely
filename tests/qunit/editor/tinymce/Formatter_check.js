...
test(
    'Selected style element text', function() {
...
test(
    'Selected style element with css styles', function() {
...
test(
    'Selected style element with attributes', function() {
...
test(
    'Selected style element text multiple formats', function() {
...
test(
    'Selected complex style element', function() {
...
test(
    'Selected non style element text', function() {
        editor.formatter.register('bold', {inline: 'b'});
...
test(
    'Selected partial style element (start)', function() {
        editor.formatter.register('bold', {inline: 'b'});
...
test(
    'Selected partial style element (end)', function() {
        editor.formatter.register('bold', {inline: 'b'});
...
test(
    'Selected element text with parent inline element', function() {
        editor.formatter.register('bold', {inline: 'b'});
...
test(
    'Selected element match with variable', function() {
...
test(
    'Selected element match with variable and function', function() {
        editor.formatter.register(
            'complex', {
                inline: 'span',
                styles: {
...
test(
    'formatChanged simple format', function() {
        var newState, newArgs;

        editor.formatter.formatChanged(
            'bold', function(state, args) {
                newState = state;
                newArgs = args;
            }
        );
...
test(
    'formatChanged complex format', function() {
        var newState, newArgs;

        editor.formatter.register('complex', {inline: 'span', styles: {color: '%color'}});

        editor.formatter.formatChanged(
            'complex', function(state, args) {
                newState = state;
                newArgs = args;
            }, true
        );
...
test(
    'Match format on div block in inline mode', function() {
...
test(
    'Get preview css text for formats', function() {
