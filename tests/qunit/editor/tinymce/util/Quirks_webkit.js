...
if (tinymce.isWebKit) {
    test(
        'Delete from beginning of P into H1', function() {
    ...
    */
    ...
    test(
        'Delete between empty paragraphs', function() {
    ...
    test(
        'Delete range from middle of H1 to middle of span in P', function() {
    ...
    test(
        'Delete from beginning of P with style span inside into H1 with inline block', function() {
    ...
    test(
        'Delete from beginning of P with style span inside into H1', function() {
    ...
    test(
        'Delete from beginning of P into H1 with contentEditable:false', function() {
    ...
    test(
        'Delete from beginning of P with style span inside into H1 with trailing BR', function() {
    ...
    test(
        'Delete from empty P with style span inside into H1', function() {
    ...
    test(
        'Delete from beginning of P with span style to H1', function() {
    ...
    test(
        'Delete from beginning of P with BR line to H1', function() {
    ...
    test(
        'ForwardDelete from end of H1 to P with style span', function() {
            editor.getBody().innerHTML = '<h1>a</h1><p><span style="color:red">b</span></p>';
    ...
    test(
        'ForwardDelete from end of H1 with trailing BR to P with style span', function() {
    ...
    test(
        'ForwardDelete from end of H1 with two trailing BR:s to P with style span', function() {
    ...
    test(
        'ForwardDelete from end of H1 to P with style and inline block element', function() {
    ...
    test(
        'ForwardDelete from end of H1 with BR line to P', function() {
    ...
    test(
        'ForwardDelete from end of H1 into P', function() {
            editor.getBody().innerHTML = '<h1>a</h1><p>b</p>';
            Utils.setSelection('h1', 1);
            editor.execCommand('ForwardDelete');
            equal(Utils.cleanHtml(editor.getBody().innerHTML), '<h1>ab</h1>');
    ...
    test(
        'ForwardDelete from end of H1 into P with contentEditable:false', function() {
    ...
    test(
        'ForwardDelete from end of H1 into P with style span inside', function() {
    ...
    test(
        'Backspace key from beginning of P into H1', function() {
            editor.getBody().innerHTML = '<h1>a</h1><p>b</p>';
            Utils.setSelection('p', 0);
    ...
    test(
        'Delete key from end of H1 into P', function() {
            editor.getBody().innerHTML = '<h1>a</h1><p>b</p>';
            Utils.setSelection('h1', 1);
    ...
    test(
        'Backspace previous word', function() {
    ...
    test(
        'Backspace previous line', function() {
            editor.getBody().innerHTML = '<p>abc 123</p>';
            Utils.setSelection('p', 7);
    ...
    test(
        'Type over bold text in fully selected block and keep bold', function() {
    ...
    test(
        'Type over partial bold text and keep bold', function() {
    ...
    test(
        'Type over bold text wrapped inside other formats', function() {
    ...
    test(
        'Delete last character in formats', function() {
    ...
    test(
        'ForwardDelete last character in formats', function() {
            editor.getBody().innerHTML = '<p><b><i>b</i></b></p>';
    ...
    test(
        'Delete in empty in formats text block', function() {
            var rng;
    ...
    test(
        'ForwardDelete in empty formats text block', function() {
            var rng;
    ...
    test(
        'Type over all contents', function() {
    ...
    test(
        'ForwardDelete all contents', function() {
            editor.getBody().innerHTML = '<p>abc</p>';
            Utils.setSelection('p', 0, 'p', 3);
            editor.fire('keydown', {keyCode: 46});
    ...
    test(
        "Skipped since the browser isn't WebKit", function() {
            ok(true, "Skipped");
        }
    );
}
