...
test(
    "fire (no event listeners)", function() {
...
test(
    "fire (event listeners) stopImmediatePropagation", function() {
        var dispatcher = new tinymce.util.EventDispatcher(), data = '';
...
test(
    "off (all specific observer)", function() {
        var dispatcher = new tinymce.util.EventDispatcher(), data = '';
...
test(
    "beforeFire setting (stopImmediatePropagation)", function() {
