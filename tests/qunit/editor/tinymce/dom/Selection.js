ModuleLoader.require(
    ...
    "tinymce/Env"
        ...
        test(
            'getBookmark/setBookmark (persistent)', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (simple)', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - simple text selection', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get non intrusive bookmark simple element selection', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get non intrusive bookmark multiple elements text selection', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive)', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - fragmentext text (normalized)', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark before/after image', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark after image', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark before element', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark after element', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark inside element', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark inside root text', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark (nonintrusive) - Get bookmark inside complex html', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark on cE=false', function() {
                var bookmark;
        ...
        test(
            'getBookmark/setBookmark before cE=false', function() {
                var rng, bookmark;
        ...
        test(
            'getBookmark/setBookmark before cE=false block', function() {
                var rng, bookmark;
        ...
        test(
            'select table text 1', 2, function() {
        ...
        test(
            'select table text 2', 2, function() {
        ...
        test(
            'normalize to text node from document', function() {
                var rng;
        ...
        test(
            'normalize to br from document', function() {
                var rng;
        ...
        if (tinymce.Env.range) {
            test(
                'normalize with contentEditable:false element', function() {
                    var rng;
            ...
            test(
                'normalize with contentEditable:false parent and contentEditable:true child element', function() {
            ...
            test(
                'normalize with contentEditable:true parent and contentEditable:false child element', function() {
            ...
            test(
                'normalize to text node from body', function() {
                    var rng;
            ...
            test(
                'normalize to br from body', function() {
                    var rng;
            ...
            test(
                'normalize to before/after img', function() {
                    var rng;
            ...
            test(
                'normalize to text node inside P', function() {
                    var rng;
            ...
            test(
                'normalize lean left if at the start of text node', function() {
                    var rng;
            ...
            test(
                'normalize lean start to the right if at end of text node', function() {
                    var rng;
            ...
            test(
                'normalize lean left but break before br', function() {
                    var rng;
            ...
            test(
                'normalize lean left but break before img', function() {
                    var rng;
            ...
            test(
                'normalize lean left but don\'t walk out the parent block', function() {
                    var rng;
            ...
            test(
                'normalize lean left into empty inline elements when caret is before br', function() {
                    var rng;
            ...
            test(
                'normalize don\'t lean left into empty inline elements if there is a br element after caret', function() {
                    var rng;
            ...
            test(
                'normalize don\'t lean left into empty inline elements if there is a br element before caret', function() {
                    var rng;
            ...
            test(
                'normalize don\'t move start/end if it\'s before/after table', function() {
                    var rng;
            ...
            test(
                'normalize after paragraph', function() {
                    var rng;
            ...
            test(
                'normalize caret after trailing BR', function() {
                    var rng;
            ...
            test(
                'normalize caret after bogus block BR', function() {
                    var rng;
            ...
            test(
                'normalize after table should not move', function() {
                    var rng;
            ...
            */
            ...
            test(
                'normalize caret after double BR', function() {
                    var rng;
