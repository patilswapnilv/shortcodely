(function() {
    ...
    test(
        'parseStyle', 11, function() {
            var dom;

            DOM.add(document.body, 'div', {id : 'test'});

            dom = new tinymce.dom.DOMUtils(
                document, {hex_colors : true, keep_values : true, url_converter : function(u) {
                    return 'X' + u + 'Y';
                }}
            );
    ...
    test(
        'setGetAttrib', function() {
            ...
            dom = new tinymce.dom.DOMUtils(
                document, {keep_values : true, url_converter : function(u, n) {
                    return '&<>"' + u + '&<>"' + n;
                }}
            );
    ...
    test(
        'loadCSS', 1, function() {
            ...
            tinymce.each(
                document.getElementsByTagName('link'), function(n) {
    ...
    test(
        'isEmpty with list of elements considered non-empty', function() {
    ...
    test(
        'isEmpty with list of elements considered non-empty without schema', function() {
    ...
    test(
        'isEmpty on P with BR in EM', function() {
    ...
    test(
        'isEmpty on P with two BR in EM', function() {
