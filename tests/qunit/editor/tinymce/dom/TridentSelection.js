...
if (!window.getSelection) {
    test(
        "Selection of element containing text", function(){
            expect(5);
    ...
    test(
        "Single image selection", function(){
            expect(6);
    ...
    test(
        "Multiple image selection", function(){
            expect(6);
        
            editor.setContent(
                '<p><img src="about:blank" /><img src="about:blank" /></p>', {
                    format: 'raw'
                }
            );
    ...
    test(
        "Text node selection between two elements", function(){
            expect(5);
    ...
    test(
        "Mixed selection start at element end at text", function(){
            expect(5);
        
            editor.setContent(
                '<p><img src="about:blank" />text</p>', {
                    format: 'raw'
                }
            );
    ...
    test(
        "Mixed selection start at text end at element", function(){
            expect(5);
        
            editor.setContent(
                '<p>text<img src="about:blank" /></p>', {
                    format: 'raw'
                }
            );
    ...
    test(
        "Caret position before image", function(){
            expect(4);
    ...
    test(
        "Caret position between images", function(){
            expect(4);
    ...
    test(
        "Caret position after image", function(){
            expect(4);
    ...
    test(
        "Selection of empty text element", function(){
            expect(6);
    ...
    test(
        "Selection of empty text element with caret inside", function(){
            expect(6);
    ...
    test(
        "Selection end within empty element", function() {
            var rng;
    ...
    test(
        "Selection after paragraph", function() {
            var rng;
    ...
    test(
        "Selection of text outside of a block element", function() {
            var r;
    ...
    test(
        "Resizable element text selection", function() {
            var r;
    ...
    test(
        "Resizable element before table selection", function() {
            var r;
    ...
    test(
        "Fragmented text nodes after element", function() {
            var r;
    ...
    test(
        "Fragmented text nodes before element", function() {
            var r;
    ...
    test(
        "Non contentEditable elements", function() {
            var r;
    ...
    test(
        "Skipped ie_selection tests as not running in IE.", function() {
