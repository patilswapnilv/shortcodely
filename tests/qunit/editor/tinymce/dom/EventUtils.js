...
test(
    "unbind event non existing", function() {
...
test(
    "unbind multiple", function() {
        var result;

        eventUtils.bind(
            window, 'mouseup mousedown click', function(e) {
                result[e.type] = true;
            }
        );
...
test(
    "bind multiple", function() {
        var result;

        eventUtils.bind(
            window, 'mouseup mousedown', function(e) {
                result[e.type] = true;
            }
        );
...
test(
    "bind/fire bubbling", function() {
        ...
        eventUtils.bind(
            document.getElementById('inner'), 'click', function() {
                result.inner = true;
            }
        );
...
test(
    "bind/fire stopImmediatePropagation", function() {
        var result;
...
test(
    "bind/fire stopPropagation", function() {
        var result;
        ...
        eventUtils.bind(
            document.getElementById('inner'), 'click', function(e) {
                result.click3 = true;
                e.stopPropagation();
            }
        );
...
test(
    "mouseenter/mouseleave bind/unbind", function() {
        var result = {};

        eventUtils.bind(
            document.body, 'mouseenter mouseleave', function(e) {
                result[e.type] = true;
            }
        );
...
test(
    "bind unbind fire clean on null", function() {
...
test(
    "bind ready when page is loaded", function() {
        var ready;
...
test(
    "event states when event object is fired twice", function() {
        var result = {};
...
test(
    "unbind inside callback", function() {
        var data;
...
test(
    "ready/DOMContentLoaded (domLoaded = true)", function() {
        var evt;
...
test(
    "ready/DOMContentLoaded (document.readyState check)", function() {
        var evt;
