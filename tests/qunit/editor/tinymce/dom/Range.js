ModuleLoader.require(
    ...
    "tinymce/dom/Range"
        ...
        test(
            "setStartBeforeSetEndAfter", function() {
                var r = createRng();
        ...
        test(
            "test_setStartAfterSetEndBefore", function() {
                var r = createRng();
        ...
        test(
            "test_selectNodeContents", function() {
                var r = createRng();
        ...
        if (tinymce.isGecko) {
            test(
                'test_cloneContents (SKIPPED)', function() {
        ...
        test(
            "test_extractContents1", function() {
                var r = createRng();
        ...
        test(
            "test_extractContents2", function() {
                var r = createRng();
        ...
        test(
            "test_extractContents3", function() {
                var r = createRng();
        ...
        test(
            "test_compareBoundaryPoints", function() {
        ...
        test(
            "toString in part of same text node", function() {
                var rng = createRng();
        ...
        test(
            "toString in start/end of same text node", function() {
                var rng = createRng();
        ...
        test(
            "toString in start in one text node end in another", function() {
                var rng = createRng();
