(function() {
    ...
    function addTests(prefix, $) {
        test(
            prefix + 'Constructor HTML', function() {
                var $html;
        ...
        test(
            prefix + 'Constructor HTML with attributes', function() {
                var $html;
        ...
        test(
            prefix + 'Constructor selector', function() {
                var $selector;
        ...
        test(
            prefix + 'Constructor selector and context', function() {
                var $selector;
        ...
        test(
            prefix + 'Constructor array', function() {
                var $html;
        ...
        test(
            prefix + 'Constructor query instance', function() {
                var $clone;
        ...
        test(
            prefix + 'Constructor window', function() {
                var $win;
        ...
        test(
            prefix + 'static makeArray()', function() {
        ...
        test(
            prefix + 'static inArray()', function() {
        ...
        test(
            prefix + 'static isArray()', function() {
                ok($.isArray([]));
                ok(!$.isArray({}));
            }
        );
        ...
        test(
            prefix + 'static each()', function() {
                var data;

                data = '';
                $.each(
                    [1, 2, 3], function(key, value) {
                        data += '' + value + key;
                    }
                );
                ...
                data = '';
                $.each(
                    {a: 1, b: 2, c: 3}, function(key, value) {
                        data += '' + value + key;
                    }
                );
        ...
        test(
            prefix + 'add() single element', function() {
        ...
        test(
            prefix + 'add() multiple elements (duplicates)', function() {
        ...
        test(
            prefix + 'add() multiple elements (non duplicates)', function() {
        ...
        test(
            prefix + 'attr() set/get attr on element', function() {
                var $elm;
        ...
        test(
            prefix + 'attr() set/get style attr on element (IE 7)', function() {
        ...
        test(
            prefix + 'attr() set/get checked attr on element (IE 7)', function() {
        ...
        test(
            prefix + 'attr() get special attrs on element (IE 7)', function() {
        ...
        test(
            prefix + 'attr() set/get attrs on element', function() {
                var $elm;
        ...
        test(
            prefix + 'attr() set/get on non element', function() {
                var $elm;
        ...
        test(
            prefix + 'removeAttr() on element', function() {
                var $elm;
        ...
        test(
            prefix + 'prop() set/get attr on element', function() {
                var $elm;
        ...
        test(
            prefix + 'prop() set/get attrs on element', function() {
                var $elm;
        ...
        test(
            prefix + 'css() get/set single item on element', function() {
                var $elm;
        ...
        test(
            prefix + 'css() get/set items on element', function() {
                var $elm;
        ...
        test(
            prefix + 'css() set opacity', function() {
        ...
        test(
            prefix + 'remove() single element', function() {
                var $elm;
        ...
        test(
            prefix + 'remove() multiple elements', function() {
                var $elm;
        ...
        test(
            prefix + 'remove() unappended element', function() {
                var $elm;
        ...
        test(
            prefix + 'empty() single element', function() {
                var $elm;
        ...
        test(
            prefix + 'html() set on single element', function() {
                var $elm;
        ...
        test(
            prefix + 'html() get on element/elements', function() {
        ...
        */
        ...
        test(
            prefix + 'html() set DIV as child of P (IE 8)', function() {
                $('<p></p>').appendTo('#view');
        ...
        test(
            prefix + 'text() set on single element', function() {
                var $elm;
        ...
        test(
            prefix + 'text() get on element', function() {
                strictEqual($('<b><i>x</i>y</b>').text().toLowerCase(), 'xy');
            }
        );

        test(
            prefix + 'append() to element', function() {
                var $elm;
        ...
        test(
            prefix + 'prepend() to element', function() {
                var $elm;
        ...
        test(
            prefix + 'before() element', function() {
                var $elm;
        ...
        test(
            prefix + 'appendTo() to element', function() {
                var $elm;
        ...
        test(
            prefix + 'prependTo() to element', function() {
                var $elm;
        ...
        test(
            prefix + 'addClass() to element', function() {
                var $elm;
        ...
        test(
            prefix + 'removeClass() from element', function() {
                var $elm;
        ...
        test(
            prefix + 'toggleClass() on element', function() {
                var $elm;
        ...
        test(
            prefix + 'each() collection', function() {
        ...
        test(
            prefix + 'on()/off()/trigger()', function() {
        ...
        test(
            prefix + 'show()/hide() element', function() {
        ...
        test(
            prefix + 'slice/eq/first/last() on collection', function() {
        ...
        test(
            prefix + 'replaceWith() on single element with single element', function() {
                var $result;
        ...
        test(
            prefix + 'replaceWith() on single element with multiple elements', function() {
                var $result;
        ...
        */
        test(
            prefix + 'wrap() single element', function() {
        ...
        test(
            prefix + 'wrap() multiple element', function() {
        ...
        test(
            prefix + 'wrapAll() multiple element', function() {
        ...
        test(
            prefix + 'wrapInner() multiple element', function() {
        ...
        test(
            prefix + 'unwrap() single element with no siblings', function() {
                $('#view').html('<b><i>1</i></b>');
                $('#view i').unwrap();
        ...
        test(
            prefix + 'unwrap() single element with siblings', function() {
        ...
        test(
            prefix + 'clone() single element', function() {
        ...
        test(
            prefix + 'parentsUntil(selector)', function() {
                var $result;
        ...
        test(
            prefix + 'parentsUntil(element)', function() {
                var $result;
        ...
        test(
            prefix + 'parentsUntil(query)', function() {
                var $result;
        ...
        test(
            prefix + 'nextUntil(selector)', function() {
                var $result, html;
        ...
        test(
            prefix + 'nextUntil(element)', function() {
                var $result, html;
        ...
        test(
            prefix + 'nextUntil(query)', function() {
                var $result, html;
        ...
        test(
            prefix + 'prevUntil(selector)', function() {
                var $result, html;
        ...
        test(
            prefix + 'prevUntil(element)', function() {
                var $result, html;
        ...
        test(
            prefix + 'prevUntil(query)', function() {
                var $result, html;
        ...
        test(
            prefix + 'closest(selector/element/query)', function() {
                var innerMost, html;
