...
test(
    'Form elements (general)', function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
...
test(
    'Form elements (checkbox)', function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
...
test(
    'Non HTML elements and attributes', function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
...
test(
    'Pre/post process events', function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
...
test(
    'Script with non JS type attribute', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
...
test(
    'Script with tags inside a comment', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with less than', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with type attrib and less than', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with whitespace in beginning/end', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with a HTML comment and less than', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with white space in beginning, comment and less than', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with comments and cdata', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script whitespace in beginning/end and cdata', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with src attr', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with HTML comment, comment and CDATA', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with block comment around cdata', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with html comment and block comment around cdata', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with line comment and html comment', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Script with block comment around html comment', 1, function() {
        var ser = new tinymce.dom.Serializer({fix_list_elements : true});
        ser.setRules('script[type|language|src]');
...
test(
    'Style with whitespace at beginning', 1, function() {
...
test(
    'Remove internal classes', function() {
        var ser = new tinymce.dom.Serializer(
            {
