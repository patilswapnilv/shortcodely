...
test(
    'Keep header/footer intact', function() {
        expect(2);
...
test(
    'Default header/footer', function() {
        expect(1);
...
test(
    'Parse body attributes', function() {
        expect(9);
...
test(
    'fullpage_hide_in_source_view: false', function() {
...
test(
    'add/remove stylesheets', function() {
