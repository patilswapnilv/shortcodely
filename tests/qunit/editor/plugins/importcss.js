(function() {
    ...
    function fireFormatsMenuEvent(styleSheets, items) {
        menuCtrl = tinymce.ui.Factory.create(
            'menu', {
                items: items
            }
    ...
    test(
        "Import content_css files", function() {
    ...
    test(
        "Import custom importcss_merge_classes: false", function() {
    ...
    test(
        "Import custom importcss_append: true", function() {
            editor.contentCSS.push("test.css");
    ...
    test(
        "Import custom importcss_selector_filter (string)", function() {
            editor.contentCSS.push("test1.css");
    ...
    test(
        "Import custom importcss_selector_filter (function)", function() {
            editor.contentCSS.push("test1.css");
    ...
    test(
        "Import custom importcss_selector_filter (regexp)", function() {
            editor.contentCSS.push("test1.css");
            editor.settings.importcss_selector_filter = /a/;
    ...
    test(
        "Import custom importcss_groups", function() {
            editor.contentCSS.push("test1.css");
    ...
    test(
        "Import custom importcss_file_filter (string)", function() {
            editor.contentCSS.push("test1.css");
    ...
    test(
        "Import custom importcss_file_filter (function)", function() {
            editor.contentCSS.push("test1.css");
    ...
    test(
        "Import custom importcss_file_filter (regexp)", function() {
            editor.contentCSS.push("test1.css");
            editor.settings.importcss_file_filter = /test2\.css/;
    ...
    test(
        "Import custom importcss_selector_converter", function() {
            editor.settings.importcss_groups = [
    ...
    test(
        "Import custom group selector_converter", function() {
    ...
    test(
        "Import custom importcss_exclusive: true", function() {
    ...
    test(
        "Import custom importcss_exclusive: false", function() {
