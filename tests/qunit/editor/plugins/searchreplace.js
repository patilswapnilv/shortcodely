...
test(
    'Find single match in multiple elements', function() {
...
test(
    'Find single match, match case: true', function() {
...
test(
    'Find single match, whole words: true', function() {
...
test(
    'Find multiple matches', function() {
...
test(
    'Find and replace single match', function() {
        editor.getBody().innerHTML = 'a';
...
test(
    'Find and replace first in multiple matches', function() {
        editor.getBody().innerHTML = 'a b a';
        editor.plugins.searchreplace.find('a');
        ok(editor.plugins.searchreplace.replace('x'));
...
test(
    'Find and replace all in multiple matches', function() {
        editor.getBody().innerHTML = 'a b a';
        editor.plugins.searchreplace.find('a');
...
test(
    'Find multiple matches, move to next and replace', function() {
        editor.getBody().innerHTML = 'a a';
        equal(2, editor.plugins.searchreplace.find('a'));
...
test(
    'Find and replace fragmented match', function() {
...
test(
    'Find and replace all fragmented matches', function() {
        editor.getBody().innerHTML = '<b>te<i>s</i>t</b><b>te<i>s</i>t</b>';
        editor.plugins.searchreplace.find('test');
...
test(
    'Find multiple matches, move to next and replace backwards', function() {
        editor.getBody().innerHTML = 'a a';
        equal(2, editor.plugins.searchreplace.find('a'));
        editor.plugins.searchreplace.next();
...
test(
    'Find multiple matches and unmark them', function() {
        editor.getBody().innerHTML = 'a b a';
        equal(2, editor.plugins.searchreplace.find('a'));
...
test(
    'Find multiple matches with pre blocks', function() {
        editor.getBody().innerHTML = 'abc<pre>  abc  </pre>abc';
        equal(3, editor.plugins.searchreplace.find('b'));
        equal(
            Utils.normalizeHtml(editor.getBody().innerHTML), (
