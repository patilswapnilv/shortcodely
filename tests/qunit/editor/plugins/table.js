(function() {
    ...
    test(
        "Table properties dialog (get/set data from/to plain table, no adv tab)", function() {
    ...
    test(
        "Table properties dialog (get/set data from/to plain table, class list)", function() {
    ...
    test(
        "Table properties dialog (get data from full table)", function() {
            editor.setContent(
    ...
    test(
        "Table properties dialog (add caption)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
            editor.execCommand('mceTableProps');
            fillAndSubmitWindowForm(
    ...
    test(
        "Table properties dialog (remove caption)", function() {
    ...
    test(
        "Table properties dialog (change size in pixels)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
            editor.execCommand('mceTableProps');
            fillAndSubmitWindowForm(
    ...
    test(
        "Table properties dialog (change size in %)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
            editor.execCommand('mceTableProps');
            fillAndSubmitWindowForm(
    ...
    test(
        "Table properties dialog (change: border,cellpadding,cellspacing,align,backgroundColor,borderColor)", function() {
    ...
    test(
        "Table properties dialog css border", function() {
    ...
    test(
        "Table properties dialog css cell padding", function() {
            editor.settings.table_style_by_css = true;
    ...
    test(
        "Table properties dialog cell spacing", function() {
            editor.settings.table_style_by_css = true;
    ...
    test(
        "Table properties dialog border-color", function() {
            editor.settings.table_style_by_css = true;
    ...
    test(
        "Table properties dialog css border, style", function() {
            editor.settings.table_style_by_css = true;
    ...
    test(
        "Table properties dialog (get cell padding from styled cells)", function() {
            editor.settings.table_style_by_css = true;

            editor.setContent(
                '<table><tr><td style="padding: 5px">X</td></tr><tr><td style="padding: 5px">X</td></tr></table>' +
    ...
    test(
        "Table cell properties dialog (get data from plain cell)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "Table cell properties dialog (get/set data from/to plain cell, no adv tab)", function() {
    ...
    test(
        "Table cell properties dialog (get data from complex cell)", function() {
    ...
    test(
        "Table cell properties dialog (update all)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
            editor.execCommand('mceTableCellProps');
    ...
    test(
        "Table row properties dialog (get data from plain cell)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "Table row properties dialog (get data from complex row)", function() {
    ...
    test(
        "Table row properties dialog (update all)", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
            editor.execCommand('mceTableRowProps');
    ...
    test(
        "mceTableDelete command", function() {
            editor.setContent('<table><tr><td>X</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "mceTableDeleteCol command", function() {
    ...
    test(
        "mceTableDeleteRow command", function() {
    ...
    test(
        "mceTableInsertColAfter command", function() {
            editor.setContent('<table><tr><td>1</td></tr><tr><td>2</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "mceTableInsertColBefore command", function() {
            editor.setContent('<table><tr><td>1</td></tr><tr><td>2</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "mceTableInsertRowAfter command", function() {
            editor.setContent('<table><tr><td>1</td><td>2</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "mceTableInsertRowAfter command on merged cells", function() {
            editor.setContent(
                '<table>' +
    ...
    test(
        "mceTablePasteRowBefore command", function() {
            editor.setContent(
                '<table>' +
    ...
    test(
        "mceTablePasteRowAfter command", function() {
            editor.setContent(
                '<table>' +
                '<tr><td>1</td><td>2</td></tr>' +
                '<tr><td>2</td><td>3</td></tr>' +
    ...
    test(
        "mceTablePasteRowAfter from merged row source", function() {
            editor.setContent(
                '<table>' +
                '<tbody>' +
    ...
    test(
        "mceTablePasteRowAfter from merged row source to merged row target", function() {
            editor.setContent(
                '<table>' +
                '<tbody>' +
                '<tr><td colspan="2">1 2</td><td rowspan="2">3</td></tr>' +
    ...
    test(
        "mceTablePasteRowAfter to wider table", function() {
            editor.setContent(
                '<table>' +
                '<tbody>' +
    ...
    test(
        "mceTablePasteRowAfter to narrower table", function() {
            editor.setContent(
                '<table>' +
                '<tbody>' +
                '<tr><td>1a</td><td>2a</td><td>3a</td></tr>' +
    ...
    test(
        "row clipboard api", function() {
            ...
            editor.plugins.table.setClipboardRows(
                clipboardRows.concat(
                    [
                    createRow(['a', 'b']),
                    createRow(['c', 'd'])
                    ]
    ...
    test(
        "mceTableInsertRowBefore command", function() {
            editor.setContent('<table><tr><td>1</td><td>2</td></tr></table>');
            Utils.setSelection('td', 0);
    ...
    test(
        "mceTableSplitCells command", function() {
    ...
    test(
        "Delete selected cells", function() {
    ...
    test(
        "Delete empty like table cell contents", function() {
            editor.getBody().innerHTML = (
            '<table><tbody>' +
    ...
    test(
        "Is Pixel/Percentage Based Width", function() {
    ...
    test(
        "Draw bars/clear bars", function() {
            ...
            equal(
                editor.dom.select('.mce-resize-bar-row').length,
                4
            );

            equal(
                editor.dom.select('.mce-resize-bar-col').length,
                4
            );
    ...
    test(
        "Draw bars/clear bars on invalid table", function() {
    ...
    test(
        "Table newcell/newrow events", function() {
    ...
    function assertTableSelection(tableHtml, selectCells, cellContents) {
        ...
        var startTd = tinymce.grep(
            cells, function(elm) {
                return elm.innerHTML === selectCells[0];
            }
        )[0];

        var endTd = tinymce.grep(
            cells, function(elm) {
