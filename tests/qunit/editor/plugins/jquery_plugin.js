...
test(
    "Get contents using jQuery", function() {
        expect(4);
...
test(
    "Set contents using jQuery", function() {
        expect(4);
...
test(
    "append/prepend contents using jQuery", function() {
        expect(2);
...
test(
    "Find using :tinymce selector", function() {
        expect(1);
...
test(
    "Set contents using :tinymce selector", function() {
        expect(3);
...
test(
    "Get contents using :tinymce selector", function() {
        expect(1);
