(function() {
    ...
    test(
        'Italic format on single word using space', function() {
    ...
    test(
        'Bold format on single word using space', function() {
            editor.setContent('<p>**abc**\u00a0</p>');
    ...
    test(
        'Bold format on multiple words using space', function() {
    ...
    test(
        'Bold format on single word using enter', function() {
            editor.setContent('<p>**abc**</p>');
    ...
    test(
        'H1 format on single word node using enter', function() {
            editor.setContent('<p>#abc</p>');
    ...
    test(
        'OL format on single word node using enter', function() {
    ...
    test(
        'UL format on single word node using enter', function() {
            editor.setContent('<p>* abc</p>');
    ...
    test(
        'getPatterns/setPatterns', function() {
