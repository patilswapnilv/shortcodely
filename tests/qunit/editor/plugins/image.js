(function() {
    ...
    test(
        'Default image dialog on empty editor', function() {
            editor.setContent('');
    ...
    test(
        'Image dialog image_dimensions: false', function() {
    ...
    if (tinymce.Env.ceFalse) {
        test(
            'All image dialog ui options on empty editor', function() {
        ...
        test(
            'All image dialog ui options on empty editor (old IE)', function() {
                editor.settings.image_caption = true;
                editor.settings.image_list = [
                {title: 'link1', value: 'link1'},
                {title: 'link2', value: 'link2'}
    ...
    test(
        "Image recognizes relative src url and prepends relative image_prepend_url setting.", function() {
    ...
    test(
        "Image recognizes relative src url and prepends absolute image_prepend_url setting.", function() {
            var win, elementId, element;
    ...
    test(
        'Advanced image dialog border option on empty editor', function(){
    ...
    test(
        'Advanced image dialog margin space options on empty editor', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog border style only options on empty editor', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog margin style only options on empty editor', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog overriden border style options on empty editor', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog overriden margin style options on empty editor', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog non-shorthand horizontal margin style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog non-shorthand vertical margin style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog shorthand margin 1 value style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog shorthand margin 2 value style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog shorthand margin 3 value style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
    ...
    test(
        'Advanced image dialog shorthand margin 4 value style change test', function(){
            editor.settings.image_advtab = true;
            editor.settings.image_dimensions = false;
