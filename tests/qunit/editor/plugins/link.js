(function() {
    ...
    test(
        'Default link dialog on empty editor', function() {
            editor.setContent('');
    ...
    test(
        'Default link dialog on text selection', function() {
    ...
    test(
        'Default link dialog on non pure text selection', function() {
    ...
    test(
        'All lists link dialog on empty editor', function() {
    ...
    test(
        'Test new regex for non relative link setting ftp', function() {
            equal(nonRelativeRegex.test('ftp://testftp.com'), true);
        }
    );

    test(
        'Test new regex for non relative link setting http', function() {
            equal(nonRelativeRegex.test('http://testhttp.com'), true);
        }
    );

    test(
        'Test new regex for non relative link setting relative', function() {
            equal(nonRelativeRegex.test('testhttp.com'), false);
        }
    );

    test(
        'Test new regex for non relative link setting relative base', function() {
