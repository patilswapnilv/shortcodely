(function() {
    ...
    test(
        'Check default language', function() {
    ...
    test(
        'Check spellcheck button is a splitbutton (no languages)', function() {
    ...
    test(
        'Check spellcheck button is a normal button (one language)', function() {
    ...
    test(
        'Check spellcheck button is a splitbutton (many languages)', function() {
