(function() {
    ...
    if (tinymce.Env.ie) {
        test(
            "Skipped on IE since it has built in logic for autolink", function() {
                ok(true);
            }
        );
    ...
    test(
        "Urls ended with space", function() {
    ...
    test(
        "Urls ended with new line", function() {
