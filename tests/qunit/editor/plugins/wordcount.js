...
test(
    "Blank document has 0 words", function() {
        expect(1);
...
test(
    "Does not count dashes", function() {
        expect(1);
...
test(
    "Does not count asterisks, non-word characters", function() {
        expect(1);
...
test(
    "Does not count numbers", function() {
        expect(1);
...
test(
    "Does not count htmlentities", function() {
        expect(1);
...
test(
    "Counts hyphenated words as one word", function() {
        expect(1);
...
test(
    "Counts words between blocks as two words", function() {
        expect(1);
