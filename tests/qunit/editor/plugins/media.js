...
test(
    'Default media dialog on empty editor', function() {
...
test(
    "Resize complex object", function() {
        editor.setContent(
...
test(
    "Media script elements", function() {
        editor.setContent(
