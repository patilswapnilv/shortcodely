...
jQuery(
    function() {
            ...
            test(
                'mismatched passwords should return 5', function() {
                    equal(passwordStrength('password1', 'username', 'password2'), 5, 'mismatched passwords return 5');
                }
            );

            test(
                'passwords shorter than 4 characters should return 0', function() {
                    equal(passwordStrength('abc', 'username', 'abc'), 0, 'short passwords return 0');
                }
            );

            test(
                'long complicated passwords should return 4', function() {
            ...
            test(
                'short uncomplicated passwords should return 0', function() {
                    var letters = 'aaaa',
                    numbers = '1111',
                    password = 'password',
                    uppercase = 'AAAA';
            ...
            test(
                'zxcvbn password tests should return the score we expect', function() {
                    var passwords, i;
                    passwords = [
                    { pw: 'zxcvbn', score: 0 },
                    { pw: 'qwER43@!', score: 1 },
            ...
            test(
                'blacklisted words in password should be penalized', function() {
            ...
            test(
                'user input blacklist array should contain expected words', function() {
