...
jQuery(window).load(
    function() {
            ...
            test(
                'fixtures should be present', function() {
                    var widgetControl;
            ...
            test(
                'widget contents should embed (with widget-added event) when section and control expand', function() {
                    ...
                    $(document).on(
                        'widget-added', function( event, widgetElement ) {
            ...
            test(
                'widgets panel should have notice', function() {
