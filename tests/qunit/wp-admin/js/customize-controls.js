...
jQuery(window).load(
    function (){
            ...
            testCustomizerModel = function( model, expectedValues ) {
                ...
                test(
                    'Model extends proper type', function () {
                ...
                if (expectedValues.hasOwnProperty('id') ) {
                    test(
                        type + ' instance has the right id', function () {
                ...
                if (expectedValues.hasOwnProperty('title') ) {
                    test(
                        type + ' instance has the right title.', function () {
                ...
                if (expectedValues.hasOwnProperty('description') ) {
                    test(
                        type + ' instance has the right description.', function () {
                ...
                if (expectedValues.hasOwnProperty('content') ) {
                    test(
                        type + ' instance has the right content.', function () {
                ...
                if (expectedValues.hasOwnProperty('priority') ) {
                    test(
                        type + ' instance has the right priority.', function () {
                ...
                if (expectedValues.hasOwnProperty('active') ) {
                    test(
                        type + ' instance has the right active state.', function () {
                            equal(model.active(), expectedValues.active);
                        }
                    );
                }
                test(
                    type + ' can be deactivated', function () {
                        model.activate();
                        model.deactivate();
                ...
                if (type === 'Panel' || type === 'Section' ) {
                    if (expectedValues.hasOwnProperty('expanded') ) {
                        test(
                            type + ' instance has the right expanded state.', function () {
                    ...
                    test(
                        type + ' instance is collapsed after calling .collapse()', function () {
                            model.collapse();
                            ok(! model.expanded());
                        }
                    );
                    ...
                    test(
                        type + ' instance is expanded after calling .expand()', function () {
                            model.expand();
                            ok(model.expanded());
                        }
                    );
            ...
            test(
                'Previewed device defaults to desktop.', function () {
            ...
            test(
                'Setting has fixture value', function () {
                    equal(wp.customize('fixture-setting')(), 'Lorem Ipsum');
                } 
            );
            test(
                'Setting has notifications', function () {
            ...
            test(
                'Setting has findControls method', function() {
            ...
            test(
                'Setting constructor object exists', function( assert ) {
                    assert.ok(_.isObject(wp.customize.settingConstructor));
                } 
            );
            test(
                'Custom setting constructor is used', function( assert ) {
            ...
            test(
                'Control exists', function () {
                    ok(wp.customize.control.has('fixture-control'));
                } 
            );
            test(
                'Control has the fixture setting', function () {
            ...
            test(
                'Control has the section fixture section ID', function () {
                    var control = wp.customize.control('fixture-control');
                    equal(control.section(), 'fixture-section');
                } 
            );
            test(
                'Control has notifications', function ( assert ) {
            ...
            test(
                'Control can be created without settings', function() {
            ...
            test(
                'Fixture section has expected content', function () {
            ...
            test(
                'Fixture section has default params supplied', function () {
                    ...
                    jQuery.each(
                        defaultParams, function ( key, value ) {
            ...
            test(
                'Fixture panel exists', function () {
                    ok(wp.customize.panel.has('fixture-panel'));
                } 
            );
            test(
                'Fixture panel has content', function () {
            ...
            test(
                'Fixture panel has section among its sections()', function () {
                    var panel = wp.customize.panel('fixture-panel');
                    ok(-1 !== _.pluck(panel.sections(), 'id').indexOf('fixture-section'));
                } 
            );
            test(
                'Panel is not expanded by default', function () {
                    var panel = wp.customize.panel('fixture-panel');
                    ok(! panel.expanded());
                } 
            );
            ...
            test(
                'Focusing on a control will expand the panel and section', function () {
            ...
            test(
                'Fixture panel has expected content', function () {
            ...
            test(
                'Fixture panel has default params supplied', function () {
            ...
            test(
                'Section has been embedded', function () {
            ...
            test(
                'Section instance added to the wp.customize.section object', function () {
            ...
            test(
                'Section instance has right content when accessed from wp.customize.section()', function () {
                    equal(sectionInstance.params.content, sectionContent);
                }
            );

            test(
                'Section instance has no children yet', function () {
            ...
            mockControl = new wp.customize.Control(
                controlId, {
                    params: controlData,
                    previewer: wp.customize.previewer
                }
            ...
            test(
                'Control instance does not yet belong to a section.', function () {
                    equal(mockControl.section(), undefined);
                }
            );
            test(
                'Control has not been embedded yet', function () {
                    equal(mockControl.deferred.embedded.state(), 'pending');
                } 
            );

            test(
                'Control instance has the right selector.', function () {
            ...
            test(
                'Control instance was added to the control class.', function () {
            ...
            test(
                'Control instance has the right id when accessed from api.control().', function () {
                    equal(mockControlInstance.id, controlId);
                }
            );

            test(
                'Control section can be set as expected', function () {
                    mockControl.section(mockSection.id);
                    equal(mockControl.section(), mockSection.id);
                }
            );
            test(
                'Associating a control with a section allows it to be embedded', function () {
                    equal(mockControl.deferred.embedded.state(), 'resolved');
                }
            );

            test(
                'Control is now available on section.controls()', function () {
            ...
            test(
                'Panel instance is not contextuallyActive', function () {
            ...
            test(
                'findControlsForSettings(blogname)', function() {
            ...
            test(
                'dirtyValues() returns expected values', function() {
            ...
            test(
                'requestChangesetUpdate makes request and returns promise', function( assert ) {
