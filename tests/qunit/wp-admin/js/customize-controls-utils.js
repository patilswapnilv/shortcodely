...
jQuery(
    function( $ ) {
            ...
            test(
                'isKeydownButNotEnterEvent returns true' , function () {
                    ok(wp.customize.utils.isKeydownButNotEnterEvent(trueMockEvent));
                }
            );

            test(
                'isKeydownButNotEnterEvent returns false' , function () {
            ...
            test(
                'bubbleChildValueChanges notifies parent of change' , function() {
            ...
            test(
                'bubbleChildValueChanges passes a reference to its instance' , function() {
            ...
            test(
                'bubbleChildValueChanges notifies parent of change when two values are bound' , function() {
                    ok(secondBubbleTester.parent.wasChangeTriggered);
                }
            );

            test(
                'bubbleChildValueChanges passes a reference to its instance when two values are bound' , function() {
