...
jQuery(
    function( $ ) {
            ...
            test(
                'FooSuperClass is a function ', function () {
                    equal(typeof FooSuperClass, 'function');
                }
            );
            test(
                'FooSuperClass prototype has protoProp', function () {
                    equal(FooSuperClass.prototype.protoProp, 'protoPropValue');
                }
            );
            test(
                'FooSuperClass does not have protoProp', function () {
                    equal(typeof FooSuperClass.protoProp, 'undefined');
                }
            );
            test(
                'FooSuperClass has staticProp', function () {
                    equal(FooSuperClass.staticProp, 'staticPropValue');
                }
            );
            test(
                'FooSuperClass prototype does not have staticProp', function () {
            ...
            test(
                'FooSuperClass instance foo extended Class', function () {
                    equal(foo.extended(wp.customize.Class), true);
                }
            );
            test(
                'foo instance has protoProp', function () {
                    equal(foo.protoProp, 'protoPropValue');
                }
            );
            test(
                'foo instance does not have staticProp', function () {
                    equal(typeof foo.staticProp, 'undefined');
                }
            );
            test(
                'FooSuperClass instance foo ran initialize() and has supplied instanceProp', function () {
            ...
            test(
                'BarSubClass prototype has subProtoProp', function () {
                    equal(BarSubClass.prototype.subProtoProp, 'subProtoPropValue');
                }
            );
            test(
                'BarSubClass prototype has parent FooSuperClass protoProp', function () {
            ...
            test(
                'BarSubClass instance bar its initialize() and parent initialize() run', function () {
            ...
            test(
                'BarSubClass instance bar extended FooSuperClass', function () {
            ...
            test(
                'New constructor added to class' , function () {
                    equal(ConstructorTestClass.prototype.constructor , newConstructor);
                }
            );
            test(
                'Class with new constructor has protoPropValue' , function () {
            ...
            test(
                'ConstructorTestClass instance constructorTest has the new constructor', function () {
                    equal(constructorTest.constructor, newConstructor);
                }
            );

            test(
                'ConstructorTestClass instance constructorTest extended Class', function () {
                    equal(constructorTest.extended(wp.customize.Class), true);
                }
            );

            test(
                'ConstructorTestClass instance constructorTest has the added instance property', function () {
            ...
            test(
                'Handles jQuery argument' , function() {
            ...
            test(
                'Handles string argument' , function() {
            ...
            test(
                'Initialized with the right value' , function() {
            ...
            test(
                '.bind() adds new callback that fires on set()' , function() {
            ...
            test(
                'Notification object exists and has expected properties', function ( assert ) {
            ...
            test(
                'wp.customize.utils.parseQueryString works', function( assert ) {
                    var queryParams;
