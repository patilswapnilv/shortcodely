...
jQuery(
    function() {
            ...
            test(
                'next() should find the shortcode', function() {
                    var result;
            ...
            test(
                'next() should not find shortcodes that are not there', function() {
                    var result;
            ...
            test(
                'next() should find the shortcode when told to start looking beyond the start of the string', function() {
                    var result;
            ...
            test(
                'next() should find the second instances of the shortcode when the starting indice is after the start of the first one', function() {
                    var result;
            ...
            test(
                'next() should not find escaped shortcodes', function() {
                    var result;
            ...
            test(
                'next() should find shortcodes that are incorrectly escaped by newlines', function() {
                    var result;
            ...
            test(
                'next() should still work when there are not equal ammounts of square brackets', function() {
                    var result;
            ...
            test(
                'next() should find the second instances of the shortcode when the first one is escaped', function() {
                    var result;
            ...
            test(
                'next() should not find shortcodes that are not full matches', function() {
                    var result;
            ...
            test(
                'replace() should replace the shortcode', function() {
                    var result;
            ...
            test(
                'replace() should not replace the shortcode when it does not match', function() {
                    var result;
            ...
            test(
                'replace() should replace the shortcode in all instances of its use', function() {
                    var result;
            ...
            test(
                'replace() should not replace the escaped shortcodes', function() {
                    var result;
            ...
            test(
                'replace() should replace improperly escaped shortcodes that include newlines', function() {
                    var result;
            ...
            test(
                'replace() should not replace the shortcode when it is an incomplete match', function() {
                    var result;
        ...
        function shortcodeReplaceCallback( ) {
            ...
            test(
                'attrs() should return named attributes created with single, double, and no quotes', function() {
                    var expected = {
                        'named': {
                            'param': 'foo',
                            'another': 'bar',
            ...
            test(
                'attrs() should return numeric attributes in the order they are used', function() {
                    var expected = {
            ...
            test(
                'attrs() should return numeric attributes in the order they are used when they have named attributes in between', function() {
                    var expected = {
