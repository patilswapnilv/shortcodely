( function( $, QUnit, tinymce, setTimeout ) {
    ...
    QUnit.test(
        'Unordered list.', function( assert ) {
            type(
                '* a', function() {
    ...
    QUnit.test(
        'Unordered list. (fast)', function( assert ) {
            type(
                '*', function() {
                    mceType(' ', true);
                }, 'a', function() {
    ...
    QUnit.test(
        'Ordered list with content. (1)', function( assert ) {
    ...
    QUnit.test(
        'Ordered list with content. (2)', function( assert ) {
            editor.setContent('<p><strong>test</strong></p>');
    ...
    QUnit.test(
        'Only transform inside a P tag.', function( assert ) {
    ...
    QUnit.test(
        'Only transform at the start of a P tag.', function( assert ) {
    ...
    QUnit.test(
        'Only transform when at the cursor is at the start.', function( assert ) {
    ...
    QUnit.test(
        'Backspace should undo the transformation.', function( assert ) {
            editor.setContent('<p>test</p>');
            editor.selection.setCursorLocation();
    ...
    QUnit.test(
        'Backspace should undo the transformation only right after it happened.', function( assert ) {
            editor.setContent('<p>test</p>');
            editor.selection.setCursorLocation();
    ...
    QUnit.test(
        'Heading 3 with elements.', function( assert ) {
    ...
    QUnit.test(
        'Don\'t convert without content', function( assert ) {
    ...
    QUnit.test(
        'Horizontal Rule', function( assert ) {
            type(
                '---\n', function() {
    ...
    QUnit.test(
        'Inline: single character.', function( assert ) {
            type(
                '`test`', function() {
    ...
    QUnit.test(
        'Inline: two characters.', function( assert ) {
            type(
                '``test``', function() {
    ...
    QUnit.test(
        'Inline: allow spaces within text.', function( assert ) {
            type(
                '`a a`', function() {
    ...
    QUnit.test(
        'Inline: disallow \\S-delimiter-\\s.', function( assert ) {
            type(
                'a` a`', function() {
    ...
    QUnit.test(
        'Inline: allow \\s-delimiter-\\s.', function( assert ) {
            type(
                'a ` a`', function() {
    ...
    QUnit.test(
        'Inline: after typing.', function( assert ) {
    ...
    QUnit.test(
        'Inline: no change without content.', function( assert ) {
            type(
                'test `` ``` ````', function() {
                    assert.equal(editor.getContent(), '<p>test `` ``` ````</p>');
                }, assert.async() 
    ...
    QUnit.test(
        'Inline: convert with previously unconverted pattern.', function( assert ) {
    ...
    QUnit.test(
        'Inline: convert with previous pattern characters.', function( assert ) {
    ...
    QUnit.test(
        'Inline: disallow after previous pattern characters and leading space.', function( assert ) {
            editor.setContent('<p>test``` 123</p>');
            editor.selection.setCursorLocation(editor.$('p')[0].firstChild, 11);
